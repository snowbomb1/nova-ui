// Centralized SVG icons - no external dependencies
// All icons default to 24x24 and inherit currentColor
...
export const InformationCircleIcon = ({ size = 24, className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width={size} height={size} className={className}>
...
export const Bars3Icon = ({ size = 24, className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width={size} height={size} className={className}>
